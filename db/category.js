 ...
 * Description : The purpose of the category.js file is to provide 
 ...
 * Budgetier Accounts database with generic categories. 
...
const initializeCategories = () =>{
    ...
    names.forEach((name,index)=>{
        category = initialize(name, index);
        console.log(category);
    });
   
};
/**
 * Axilary function to create the Category collection of the 
 * Budgetier Accounts database with generic categories. 
 */
const initialize = async(name, index)=>{  
    const category = await Category.create({
        categoryID : index,
        name : name
    });
 ...
 * Budgetier Accounts database. This function is designed for
